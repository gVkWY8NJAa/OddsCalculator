...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.input_betAmt_A, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_win_A, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.convert_button, 14, 1, 1, 2)
        ...
        self.quitButton.setFont(font2)
        self.quitButton.setAutoDefault(False)
        self.quitButton.setFlat(False)

        self.gridLayout.addWidget(self.quitButton, 14, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_betAmt_B, 11, 2, 1, 1)
        ...
        self.label_Odds_1.setFont(font1)
        ...
        self.gridLayout.addWidget(self.input_win_B, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_payout_A, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.input_payout_B, 13, 2, 1, 1)

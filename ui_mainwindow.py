...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.quitButton, 16, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.convert_button, 16, 1, 1, 2)
        ...
        self.label_Pr = QLabel(self.centralwidget)
        self.label_Pr.setObjectName(u"label_Pr")

        self.gridLayout.addWidget(self.label_Pr, 12, 0, 1, 1)
        ...
        QWidget.setTabOrder(self.oddsA, self.oddsB)
        QWidget.setTabOrder(self.oddsB, self.convert_button)
        QWidget.setTabOrder(self.convert_button, self.quitButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_Pr.setText(QCoreApplication.translate("MainWindow", u"Probability", None))
    # retranslateUi
